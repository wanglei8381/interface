...
function bindingInterface(context) {
  ...
  context.confs.i_fs.forEach(function (confs, index) {
...
function bindingFilter(context) {
  ...
  filter.use(context.path + '/**', function (req, res, next) {
    console.log('service1111111111111111111########################filter====', req.pathname);
    next();
  }, function (req, res, next) {
    console.log('service2222222222222222222########################filter====', req.pathname);
    next();
  });
